...
public class DaibuyAdapter extends BaseAdapter {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        CircleImageView avatar = (CircleImageView)ll.findViewById(R.id.daibuy_avatar);
        TextView tv_username = (TextView)ll.findViewById(R.id.daibuy_username);
        TextView tv_daibuy_content = (TextView)ll.findViewById(R.id.daibuy_title);

        ImageView im_solve=(ImageView)ll.findViewById(R.id.daibuy_issolved);
