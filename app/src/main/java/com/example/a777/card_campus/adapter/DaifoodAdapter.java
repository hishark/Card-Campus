...
public class DaifoodAdapter extends BaseAdapter {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        CircleImageView avatar = (CircleImageView)ll.findViewById(R.id.daifood_avatar);
        TextView tv_username = (TextView)ll.findViewById(R.id.daifood_username);
        TextView tv_daifood_content = (TextView)ll.findViewById(R.id.daifood_title);
        ImageView im_solve=(ImageView)ll.findViewById(R.id.daifood_issolved);
        ...
        //tv_daifood_content.setTextColor(Color.parseColor("#757575"));
